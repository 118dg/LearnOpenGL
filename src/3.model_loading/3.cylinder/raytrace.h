...
private:
	...
	raytraceData::halfspace* raytrace::makeHalfspace(GLfloat y);
	raytraceData::direction* makeDirection(GLfloat x, GLfloat y, GLfloat z);
	raytraceData::diffuse* makeDiffuse(GLfloat r, GLfloat g, GLfloat b);
	raytraceData::specular* makeSpecular(GLfloat r, GLfloat g, GLfloat b, GLfloat shininess);
	raytraceData::intensity* makeIntensity(GLfloat r, GLfloat g, GLfloat b);
